...
#'
#' @export
CustomsubsetMaf = function(maf, tsb = NULL, genes = NULL, query = NULL, clinQuery = NULL, ranges = NULL, mult = "first", fields = NULL, mafObj = TRUE, includeSyn = TRUE, isTCGA = FALSE, dropLevels = TRUE, restrictTo = 'all'){
  ...
  if(mafObj){
    ...
    m = CustomMAF(nonSyn = maf.dat, syn = maf.silent, clinicalData = maf.anno)
...
CustomMAF = function(nonSyn = NULL, syn = NULL, clinicalData = NULL, verbose = TRUE) {
  ...
  mafSummary = CustomSummarizeMaf(maf = nonSyn, anno = clinicalData, chatty = verbose)
