...
library(ggpubr)
library('xlsx')
source('/BiO2/users/jjg/SCLC/I_SCLC/220211_MAFTOOLS_Plotting/custom_plotCE_enrichment.r')
source('/BiO2/users/jjg/SCLC/I_SCLC/Paper/220410/MAFtools/Custom_gap_oncoplot.R')
source("/BiO2/users/jjg/SCLC/I_SCLC/Paper/220410/MAFtools/Custom_oncomatrix.R")
source("/BiO2/users/jjg/SCLC/I_SCLC/custom_maf_function/Custom_summarizeMaf.R")
source("/BiO2/users/jjg/SCLC/I_SCLC/custom_maf_function/Custom_subsetMaf.R")



plot_dir = "/BiO2/users/jjg/SCLC/I_SCLC/Paper/221011_Github_code/step2_CancerScan/"
...
CNV = read.table("CS_CNV_matrix.txt", sep = "\t", header = TRUE)
maf.filename = "/BiO2/users/jjg/SCLC/I_SCLC/220207_A_N_compare/annovar_input.maf"
